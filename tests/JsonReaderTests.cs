...
#pragma warning restore CA1008 // Enums should have zero value
    ...
    [InlineData("Invalid JSON value where a JSON array was expected.", "True", 0, /*lang=json*/ "true")]
    [InlineData("Invalid JSON value where a JSON array was expected.", "String", 0, /*lang=json*/ """ "foobar" """)]
    [InlineData("Invalid JSON value; JSON array has too few values.", "EndArray", 1, /*lang=json*/ "[]")]
    [InlineData("Invalid JSON value where a JSON array was expected.", "StartObject", 0, /*lang=json*/ "{}")]
    [InlineData("Invalid JSON value; JSON array has too few values.", "EndArray", 4, /*lang=json*/ "[123]")]
    ...
    [InlineData("Invalid JSON value where a JSON array was expected.", "StartObject", 0, /*lang=json*/ "{}")]
    [InlineData("Invalid JSON value; JSON array has too few values.", "EndArray", 4, /*lang=json*/ "[123]")]
    [InlineData("Invalid JSON value; JSON array has too few values.", "EndArray", 14, /*lang=json*/"""[123, "foobar"]""")]
